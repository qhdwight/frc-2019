...
#define DRIVE_INPUT_DEAD_BAND 0.025


#define DRIVE_NEGATIVE_INERTIA_THRESHOLD 0.65
#define DRIVE_NEGATIVE_INTERTIA_TURN_SCALAR 3.5
#define DRIVE_NEGATIVE_INERTIA_CLOSE_SCALAR 4.0
#define DRIVE_NEGATIVE_INERTIA_FAR_SCALAR 5.0
