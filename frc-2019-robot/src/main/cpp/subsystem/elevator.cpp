...
namespace garage {
    ...
    void Elevator::ConfigSpeedControllers() {
        ...
        // Safety
        m_ElevatorMaster.ConfigClosedLoopPeakOutput(ELEVATOR_MOTION_MAGIC_PID_SLOT, 0.5, CONFIG_TIMEOUT);
...
//        }
    ...
    void SetPointElevatorController::Control() {
        ...
        if (elevator->m_EncoderPosition > ELEVATOR_MIN_CLOSED_LOOP_HEIGHT && elevator->m_EncoderPosition < ELEVATOR_MAX) {
